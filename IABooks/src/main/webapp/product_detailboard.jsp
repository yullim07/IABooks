	...
	<div class="contents">
				...
				<table class="table" id="faq_table_all">
					...
					<tbody id="faq_tbody">
						<tr id="review_content">
							...
							<td class="tbl_subject" id="td_left"><a href=""> 배송도 빠르도
									책도 잘 포장돼서 왔어요! </a> <img id="file_attach" name="file_attach"
								src="<%= ctxPath%>/jaehee_pages/semi_images/ico_attach2.gif" <%-- onmouseover="showImg()" onmouseout="hideImg()"--%> />

								<span id="mouseover_img" style="position: absolute;"></span> <span
								class="new_tag">NEW</span>
							<td class="tbl_writer mycenter">네****</td>
							<td class="tbl_date mycenter">2022-03-17</td>
							<td class="tbl_readcount mycenter"><span>1</span></td>
							<td class="tbl_grade mycenter"><img name="star_point"
								src="<%= ctxPath%>/jaehee_pages/semi_images/ico_point5.gif" /></td>
						</tr>
						...
						<tr id="review_content">
							...
							<td class="tbl_subject" id="td_left"><a href=""> 우리팀
									화이팅! </a> <img id="file_attach" name="file_attach"
								src="<%= ctxPath%>/jaehee_pages/semi_images/ico_attach2.gif" <%-- onmouseover="showImg()" onmouseout="hideImg()"--%> />
						...
						<tr id="notExist">
							<td colspan="6">
								<div>
									<span style="color: #555555; font-weight: bold;">표시할 내용이
										없습니다.</span>
								</div>
							</td>
						</tr>
		...
		<div class="search_outer">
			<div class="search_inner">
				<a><img
					src="<%= ctxPath%>/jaehee_pages/semi_images/ico_triangle3.gif" /></a>
				...
				</select> <select id="searchContent" name="search">
