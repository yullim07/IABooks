	...
	<div class="table table-responsive">
		...
		<table class=" write_review">
		    ...
		    <tr>
		      ...
		      <td class="col-10" ><input type="text" id="qnaSubject" name="qnaSubject" value="${(requestScope.faqVO).faq_title}" /></td>
		    </tr>
		    ...
		    <tr>
				...
				<td><input type="radio" name="qnaIssecret" id="qnaPublic" value="${(requestScope.qnaVO).issecret}"/>공개글&nbsp;<input type="radio" name="qnaIssecret" id="qnaSecret" value="1" />비밀글</td>
			</tr>
