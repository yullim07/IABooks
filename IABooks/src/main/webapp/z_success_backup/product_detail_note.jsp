...
<link rel="stylesheet" type="text/css" href="<%= ctxPath%>/jaehee_pages/semicss/semi_style.css" />
		...
		<div id="detail_top" class="row">
			...
			<div id="detail_top_img" class="col-lg-6">
				...
				<div class="detail_img_display">
					...
					<%-- 단점 : 두 번 뜸 >> href="" 로 해주면 된다! --%>
					<%-- <a href = "javascript:popup()" target = "_blank"></a> --%>
					<%-- 단점 : 차단됨 --%>
					<%-- <img class="big" style="width: 400px; cursor: pointer;" onClick="window.open('pop_images.jsp', '미리보기', 'width=500, height=800, toolbar=no, location=no, status=yes, scrollbars=yes, resizeable=no, left=200, top=200')"> --%>
					<%-- 단점 : 이미지를 클릭해야지만 이미지가 뜬다. --%>
			...
			<div id="text_area" class="col-lg-6" style="float: none; margin: 0 auto; max-width: 40%;">
				<!-- 상품보기 제품제목(detail_text_title) 시작 -->
				<!-- 상품보기 제품제목(detail_text_title) 끝 -->
				
				<!-- 상품보기 제품가격(detail_text_price) 시작 -->
				<!-- 상품보기 제품가격(detail_text_price) 끝 -->
				
				<!-- 상품보기 총주문액(detail_text_total) 시작 -->
				<!-- 상품보기 총주문액(detail_text_total) 끝 -->
				
				<!-- 상품보기 구매버튼(detail_text_button) 시작 -->
				<div class="detail_text_button row" style="margin: 20px 0 20px 0;">
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			// *** 메인이미지 클릭 시 팝업창으로 띄우기 시작 *** //
			// var img = document.getElementsByClassName('big');
			/* for(var i=0; x < bigPic.length; i++) {
				bigPic.item(i).onclick = function() {window.open(this.src)};
			} */
			// *** 메인이미지 클릭 시 팝업창으로 띄우기 끝 *** //
		
			
			// *** 메인이미지 클릭 시 팝업창 띄우기 시작 ***//
			/* function popup(){
				var url = "pop_images.jsp";
				var name = "미리보기";
				var option = "width = 500, height = 500, top = 100, left = 200, location = no"
				window.open(url, name, option);
			} */
			// *** 메인이미지 클릭 시 팝업창 띄우기 끝 ***//
