...
public class GoogleMail {
	...
	public void sendmail(String recipient, String certificationCode) throws Exception {
        ...
        prop.put("mail.smtp.user", "moonby9090@gmail.com");
        ...
        // 제목 설정
        String subject = "localhost:9090/IABooks/index.book 회원님의 비밀번호를 찾기위한 인증코드 발송";
        msg.setSubject(subject);
                
        // 보내는 사람의 메일주소
        String sender = "moonby9090@gmail.com";
